    ...
    <div className="max-w-7xl mx-auto p-4 md:p-6 lg:p-8 flex flex-col xl:flex-row gap-8">
      ...
      <div className="flex-1">
        ...
        <div className="mt-6 flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
          <Link to={`/c/${video.owner?.username}`} className="flex items-center gap-4 group">
            <img 
            ...
            <div>
              ...
              <p className="text-sm text-zinc-400">Subscriber count coming soon</p>
            </div>
          </Link>

          <button className="flex items-center gap-2 px-6 py-2.5 bg-white text-black hover:bg-zinc-200 font-bold rounded-full transition-colors">
